...
response = WS.sendRequest(findTestObject('POSTS/POSTPosts'))
...
WS.verifyElementPropertyValue(response, 'body', 'asignment 2 nina')

//testcase method DELETE
response = WS.sendRequest(findTestObject('POSTS/DELETE'))
WS.verifyResponseStatusCode(response, 200)